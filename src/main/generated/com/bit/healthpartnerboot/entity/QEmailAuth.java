...
public class QEmailAuth extends EntityPathBase<EmailAuth> {
    ...
    private static final long serialVersionUID = 1111794839L;
    ...
    public final EnumPath<com.bit.healthpartnerboot.dto.AuthType> authType = createEnum("authType", com.bit.healthpartnerboot.dto.AuthType.class);
